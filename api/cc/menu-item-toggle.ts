...
export type CCMenuItemToggleNamespace = {
  /**
   ...
   * @param params
   */
  new (...params: [...CCMenuItem[], Function | string | undefined, CCNode | undefined]): CCMenuItemToggle;
  new (): CCMenuItemToggle;
   ...
   */
  create(...params: [...CCMenuItem[], Function | string | undefined, CCNode | undefined]): CCMenuItemToggle;
  create(): CCMenuItemToggle;
} & CCMenuItemNamespace;
