...
export type CCMenuNamespace = {
   ...
   * @param menuItem
   */
  new (...menuItem: CCMenuItem[]): CCMenu;
  new (): CCMenu;
   ...
   * new cc.Menu(menuitem1, menuitem2, menuitem3) to create a new menu.
   */
  create(...menuItem: CCMenuItem[]): CCMenu;
  create(): CCMenu;
} & CCLayerNamespace;
