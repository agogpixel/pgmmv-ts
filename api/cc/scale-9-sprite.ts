...
export type CCScale9SpriteNamespace = {
  /**
   ...
   * @param capInsets
   */
  new (file?: string | CCSpriteFrame, rectOrCapInsets?: CCRect, capInsets?: CCRect): CCScale9Sprite;

  /**
   * Creates a 9-slice sprite with a texture file, a delimitation zone and with the specified cap insets.
   *
   * @param file File name of texture or a SpriteFrame.
   * @param rectOrCapInsets The rect of the texture or cap insets.
   * @param capInsets Cap insets when rect is specified.
   * @returns Scale9Sprite instance.
   * @deprecated Since v3.0, please use new constructor instead.
   */
  create(file?: string | CCSpriteFrame, rectOrCapInsets?: CCRect, capInsets?: CCRect): CCScale9Sprite;
   ...
   * @deprecated Since v3.0, please use new constructor instead.
   */
  createWithSpriteFrame(spriteFrame?: CCSpriteFrame, capInsets?: CCRect): CCScale9Sprite;
   ...
   * @deprecated Since v3.0, please use new constructor instead.
   */
  createWithSpriteFrameName(spriteFrameName?: string, capInsets?: CCRect): CCScale9Sprite;
} & CCNodeNamespace;
