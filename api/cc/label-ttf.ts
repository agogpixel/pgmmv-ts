...
import type { CCSprite, CCSpriteNamespace } from './sprite';

export type CCLabelTTFNamespace = {
  /**
  ...
  new (
    text?: string,
    fontName?: string | CCFontDefinition,
    fontSize?: number,
    dimensions?: CCSize,
    hAlignment?: number,
    vAlignment?: number
   ...
   * @deprecated since v3.0, please use the new construction instead.
   */
  createWithFontDefinition(def: CCFontDefinition): CCLabelTTF;
} & CCSpriteNamespace;
