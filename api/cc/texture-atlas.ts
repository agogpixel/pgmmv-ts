...
export type CCTextureAtlasNamespace = {
  /**
   ...
   * @param capacity
   */
  new (fileName?: string | CCTexture2D, capacity?: number): CCTextureAtlas;
   ...
   */
  create(fileName?: string | CCTexture2D, capacity?: number): CCTextureAtlas;

  /**
   * @deprecated since v3.0, please use new cc.TextureAtlas(texture) instead.
   */
  createWithTexture: CCTextureAtlasNamespace['create'];
} & CCClassNamespace;
