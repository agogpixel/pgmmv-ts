...
export type CCSpriteNamespace = {
   ...
   */
  new (fileName?: string | CCSpriteFrame | HTMLImageElement | CCTexture2D, rect?: CCRect, rotated?: boolean): CCSprite;
   ...
   */
  create(
    fileName?: string | CCSpriteFrame | HTMLImageElement | CCTexture2D,
    rect?: CCRect,
    rotated?: boolean
  ): CCSprite;
   ...
   * @deprecated since v3.0, please use new construction instead.
   */
  createWithSpriteFrame: CCSpriteNamespace['create'];

  /**
   * @deprecated since v3.0, please use new construction instead.
   */
  createWithSpriteFrameName: CCSpriteNamespace['create'];

  /**
   * @deprecated since v3.0, please use new construction instead.
   */
  createWithTexture: CCSpriteNamespace['create'];
