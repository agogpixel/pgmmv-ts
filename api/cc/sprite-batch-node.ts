...
export type CCSpriteBatchNodeNamespace = {
   ...
   */
  create(fileImage: string | CCTexture2D): CCSpriteBatchNode;

  /**
   * @deprecated since v3.0, please use new construction instead.
   */
  createWithTexture: CCSpriteBatchNodeNamespace['create'];
} & CCNodeNamespace;
